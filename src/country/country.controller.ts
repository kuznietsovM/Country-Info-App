...
export class CountryController {
    ...
    async findByCode(
        ...
        const { populationCounts } = await this.countriesNowService.getCountryPopulationData(commonName)
        const { flag } = await this.countriesNowService.getCountryFlagUrl(params.countryCode)
